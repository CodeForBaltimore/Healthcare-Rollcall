      ...
      <b-col cols="12" md="4">
        <b-card title="Contact Information">
          ...
          <h6
            ...
            v-if="entity.contacts && entity.contacts.length > 0"
          >Contacts</h6>
          ...
          <ul v-if="entity.contacts && entity.contacts.length > 1">
            <li v-for="contact in entity.contacts" v-bind:key="contact.id">
              <a
          ...
          <b-button v-bind:href="`/contact/${entity.id}/`">Add Contact</b-button>
        </b-card>
      </b-col>
      <b-col cols="12" md="8">
        <b-row>
          <b-col>
            ...
            <ol>
              <li
                v-if="entity.phone || (entity.contacts && entity.contacts[0].contact.phone.length > 0)"
              >
                ...
                <span
                  v-if="entity.phone && !entity.contacts[0].contact.phone[0].number"
                >{{ entity.phone[0].number | phone }}</span>
              </li>
              <li
                v-if="!entity.phone && !entity.contacts[0].contact.phone.length > 0"
              >Contact the facility using the contact information to the left.</li>
            ...
            <b-card title="New Check-In" class="facility-check-in">
              ...
              <b-form @submit="addNewCheckin" @reset="resetCheckin" v-if="showForm">
                ...
                <b-form-group
                  ...
                  v-bind:label="newCheckIn.questionnaire.question1[0].label"
                >
                  <b-form-radio
                    required
                    v-model="newCheckIn.questionnaire.question1[0].value"
                    name="question-1-radio"
                    value="Yes"
                  >Yes</b-form-radio>
                  <b-form-radio
                    required
                ...
                <b-form-group
                  ...
                  v-bind:label="newCheckIn.questionnaire.question2[0].label"
                >
                  <b-form-radio
                    required
                    v-model="newCheckIn.questionnaire.question2[0].value"
                ...
                <b-form-group
                  ...
                  v-bind:label="newCheckIn.questionnaire.question2[1].label"
                >
                  <b-form-radio
                    required
                    v-model="newCheckIn.questionnaire.question2[1].value"
                ...
                <b-form-group
                  ...
                  v-bind:label="newCheckIn.questionnaire.question2[2].label"
                >
                  <b-form-radio
                    required
                    v-model="newCheckIn.questionnaire.question2[2].value"
                    name="question-2c-radio"
                    value="Yes"
                  >Yes</b-form-radio>
                  <b-form-radio
                    required
                ...
                <b-form-group
                  ...
                  v-bind:label="newCheckIn.questionnaire.question2[3].label"
                >
                  <b-form-radio
                    required
                    v-model="newCheckIn.questionnaire.question2[3].value"
                ...
                <h5>Question 3</h5>
                <b-form-group
                  id="check-in-input-question-3"
                  v-bind:label="newCheckIn.questionnaire.question3[0].label"
                ...
                <h5>Question 4</h5>
                <b-form-group
                  id="check-in-input-question-4"
                  v-bind:label="newCheckIn.questionnaire.question4[0].label"
                ...
                <h5>Question 5</h5>
                <b-form-group
                  id="check-in-input-question-5"
                  v-bind:label="newCheckIn.questionnaire.question5[0].label"
                ...
                <b-form-group
                  ...
                  v-bind:label="newCheckIn.questionnaire.comments.label"
                  label-for="comments"
                >
                  <b-form-textarea
                    id="comments"
                ...
                <b-form-group id="check-in-input-status" label="Facility Operating Status">
                  ...
                  <b-form-radio
                    ...
                    name="question-status"
                    value="Monitoring"
                  >Monitoring</b-form-radio>
                  <b-form-radio
                    required
                    v-model="newCheckIn.status"
                    name="question-status"
                    value="Critical"
                  >Critical</b-form-radio>
                </b-form-group>
